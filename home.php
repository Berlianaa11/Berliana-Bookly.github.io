...
<section class="home">
   ...
   <div class="content">
      ...
      <p>Buku adalah jendela dunia, ayo dapatkan buku terbaikmu sekarang.</p>
      <a href="about.php" class="white-btn">Cari lebih banyak</a>
   </div>
...
<section class="products">
   ...
   <div class="box-container" style="grid-template-columns: repeat(auto-fit, 28rem)">
   ...
   <div class="load-more" style="margin-top: 2rem; text-align:center">
      <a href="shop.php" class="option-btn">Selanjutnya</a>
   </div>
...
<section class="home-contact">
   ...
   <div class="content">
      ...
      <p>Hubungi kami untuk lebih tahu mengenai buku yang anda inginkan!</p>
